...
#background image 
bg = ImageTk.PhotoImage(file = "../pharms.jpg") 
...
def app(click):
    ...
    #apply ocr 
    result = ocr_model.ocr(os.path.join('../uploaded_images/med.jpg'))
    if result:  
      output=" "
      for res in result:
        if res:
   ...
   #store name 
      ...
      if ores: 
        ...
        #database connection
        conn=mysql.connector.connect(host="localhost",username="<your-username>",password="<your-mysql-password>",database="<your-database-name>")
