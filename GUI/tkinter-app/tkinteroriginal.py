...
def app(click):
   ...
   #store name 
    ...
    if ores: 
      ...
      column_labels = [ "DRUG_NAME", "DOSAGE_FORM_AND_STRENGTH", "INDICATIONS","CONTRAINDICATIONS_OR_PRECAUTIONS", "DOSAGE_SCHEDULE", "ADVERSE_EFFECTS", "DRUG_AND_FOOD_INTERACTIONS"]
